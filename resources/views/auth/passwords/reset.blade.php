                ...
                <div class="col-lg-5 col-md-7">
                    <div class="card bg-secondary border-0 mb-0">
                        ...
                        <div class="card-body px-lg-5 py-lg-5">
                            ...
                            @endif
                            <form role="form" action="{{ secure_redirect(route('password.update')) }}" method="post">
                                @csrf
                                ...
                                <div class="form-group mb-3">
                                    <div class="input-group input-group-merge input-group-alternative">
                                        ...
                                        <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email"
                                               value="{{ $email ?? old('email') }}" required autocomplete="email" autofocus placeholder="E-Mail Address">
                                    </div>
                                </div>
                                <div class="form-group mb-3">
                                    <div class="input-group input-group-merge input-group-alternative">
                                ...
                                <div class="text-center">
                                    <button type="submit" class="btn btn-success bg-cp my-4 text-capitalize">Reset Password</button>
                                </div>
                            </form>
                        </div>
                    </div>
                    <div class="row mt-3">
                        <div class="col-6">
                            <a href="{{ secure_redirect(route('login')) }}" class="text-light">
                                <small class="text-capitalize">Login Now</small>
                            </a>
                        </div>
                    </div>
                </div>
