<div class="tab-pane fade" :class="{'show': model.sel_tab === 'translation', 'active': model.sel_tab === 'translation'}" id="tabs-translation" role="tabpanel" aria-labelledby="tabs-translation-tab">
    <div class="tabs-translation tabs-data-entry">
        <div class="form-row">
            <div class="col-md-4">
