...
<div style="display: inline-block; margin-right: 20px;padding: 8px 0;"
     v-else-if="model.content.video_code === '' && model.content.video_type === 'other'">
...
<div style="display: inline-block; margin-right: 20px;padding: 8px 0;"
     v-else-if="model.content.content_youtube_url === '' && model.content.video_type === 'youtube'">
    <div style="width: 280px; height: 158px; background: #000000; display: flex; justify-content: center; align-items: center; font-size: 40px;">
        <i class="fas fa-play"></i>
    </div>
</div>
...
<div style="display: inline-block; margin-right: 20px;padding: 8px 0;"
     v-else-if="model.content.content_vimeo_url === '' && model.content.video_type === 'vimeo'">
    <div style="width: 280px; height: 158px; background: #000000; display: flex; justify-content: center; align-items: center; font-size: 40px;">
        <i class="fas fa-play"></i>
    </div>
</div>
