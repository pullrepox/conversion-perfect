<div class="tab-pane fade" :class="{'show': model.sel_tab === 'main', 'active': model.sel_tab === 'main'}" id="tabs-main" role="tabpanel" aria-labelledby="tabs-main-tab">
    <div class="tabs-main tabs-data-entry">
        <div class="form-row">
            <div class="col-md-4">
            ...
            <div class="col-md-4" v-show="model.show_bar_type === 'delay'">
                <div class="form-group">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-2 col-sm-3 mt--1">@{{ model.delay_in_seconds }}s</div>
            ...
            <div class="col-md-4" v-show="model.show_bar_type === 'scroll'">
                <div class="form-group">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-2 col-sm-3 mt--1">@{{ model.scroll_point_percent }}%</div>
