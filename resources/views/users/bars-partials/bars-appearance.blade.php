<div class="tab-pane fade" :class="{'show': sel_tab === 'appearance', 'active': sel_tab === 'appearance'}" id="tabs-appearance" role="tabpanel" aria-labelledby="tabs-appearance-tab">
    <div class="form-row">
        <div class="col-md-4">
                ...
                <div class="radio ml-1">
                    <label class="custom-toggle custom-toggle-light">
                        <input type="checkbox" id="drop_shadow" name="drop_shadow"
                               ...
                               data-parent="appearance" v-model="model.appearance.drop_shadow" @input="changed_status = true">
                ...
                <div class="radio ml-1">
                    <label class="custom-toggle custom-toggle-light">
                        <input type="checkbox" id="close_button" name="close_button"
                               ...
                               data-parent="appearance" v-model="model.appearance.close_button" @input="changed_status = true">
                        <span class="custom-toggle-slider rounded-circle" data-label-off="No" data-label-on="Yes"></span>
                    </label>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="row">
                    <div class="col-md-10 col-sm-9">
                        <vue-slider :speed="1" :min="0" :max="100" v-model="model.appearance.opacity" id="opacity" @change="changed_status = true"></vue-slider>
                    </div>
    ...
    <div class="form-row">
                ...
                <div class="radio ml-1">
                    <label class="custom-toggle custom-toggle-light">
                        <input type="checkbox" id="background_gradient" name="background_gradient"
                               ...
                               data-parent="appearance" v-model="model.appearance.background_gradient" @input="changed_status = true">
                        <span class="custom-toggle-slider rounded-circle" data-label-off="No" data-label-on="Yes"></span>
                    </label>
                </div>
            </div>
        ...
        <div class="col-md-4" v-show="model.appearance.background_gradient">
            <div class="form-group">
                ...
                <div class="row">
                    <div class="col-md-10 col-sm-9">
                        <vue-slider :speed="1" :min="0" :max="360" v-model="model.appearance.gradient_angle" id="gradient_angle" @change="changed_status = true"></vue-slider>
                    </div>
