<div style="height: 268px; width: 100%; font-size: 20px; font-family: 'Nunito', sans-serif; text-align: center;"
     :style="{
    ...
    <div style="margin: 0 0 0 63%; width: 0; height: 0; border-left: 15px solid transparent; border-right: 15px solid transparent;"
         :style="{
