<div class="tab-pane fade" :class="{'show': model.sel_tab === 'timer', 'active': model.sel_tab === 'timer'}" id="tabs-timer" role="tabpanel" aria-labelledby="tabs-timer-tab">
    <div class="tabs-timer tabs-data-entry">
        <div class="form-row">
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-2 col-sm-3 mt--1">@{{ model.timer.countdown_days }}</div>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-2 col-sm-3 mt--1">@{{ model.timer.countdown_hours }}</div>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-2 col-sm-3 mt--1">@{{ model.timer.countdown_minutes }}</div>
