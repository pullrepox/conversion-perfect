<div class="tab-pane fade" :class="{'show': model.sel_tab === 'lead_capture', 'active': model.sel_tab === 'lead_capture'}" id="tabs-lead_capture" role="tabpanel"
     aria-labelledby="tabs-lead_capture-tab">
    <div class="tabs-lead_capture tabs-data-entry">
        <div class="form-row">
            <div class="col-md-4">
            ...
            <div class="col-md-4" v-show="model.lead_capture.after_submit === 'show_message_hide_bar'">
                <div class="form-group">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-2 col-sm-3 mt--1">@{{ model.lead_capture.autohide_delay_seconds }}s</div>
