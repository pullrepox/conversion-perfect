<div class="tab-pane fade" :class="{'show': model.sel_tab === 'overlay', 'active': model.sel_tab === 'overlay'}" id="tabs-overlay" role="tabpanel" aria-labelledby="tabs-overlay-tab">
    <div class="tabs-overlay tabs-data-entry">
        <div class="form-row">
            <div class="col-md-4">
