@if ($bar->third_party_url != "")
    <iframe src="{{ $bar->third_party_url }}" width="100%" height="100%" style="border: 0"></iframe>
@else
    <!doctype html>
    ...
    <script type="text/javascript">
        window.__cp_bar_config = {
            "{{ $bar->id }}": {
                ...
                token: "{{ csrf_token() }}",
                act_btn_action: "{{ route("conversion.set-lead-capture-subscribers", ["id" => $bar->id]) }}",
