...
@section('title', 'Split Test Bars Report - ' . config('app.name'))
@section('content')
            ...
            <div class="card">
                ...
                <div class="table-responsive custom-table">
                    <table class="table align-items-center table-flush">
                        ...
                        <tbody>
                        <tr>
                            <td>{{ $splitTest->split_bar_name }}</td>
                            <td>
                                {{ $total_sum[0] }}
                            </td>
                            <td>
                    ...
                    <div class="row">
                        ...
                        <div class="col text-right">
                            <div class="btn-group" role="group" aria-label="Period">
                                <a href="{{ secure_redirect(route('split-tests.show', ['splitTest' => $splitTest->id, 'report' => true, 'period' => 'day'])) }}"
                                   class="btn btn-info btn-sm {{ $searchParams['period'] == 'day' ? 'active' : '' }}">
                                    Today
                                </a>
                                <a href="{{ secure_redirect(route('split-tests.show', ['splitTest' => $splitTest->id, 'report' => true, 'period' => 'week'])) }}"
                                   class="btn btn-info btn-sm {{ $searchParams['period'] == 'week' ? 'active' : '' }}">
                                    Last 7days
                                </a>
                                <a href="{{ secure_redirect(route('split-tests.show', ['splitTest' => $splitTest->id, 'report' => true, 'period' => 'month'])) }}"
