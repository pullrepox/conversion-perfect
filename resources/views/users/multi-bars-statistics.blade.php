...
@section('title', 'Multi Bar Report - ' . config('app.name'))
@section('content')
                    ...
                    <div class="row">
                        ...
                        <div class="col text-right">
                            <div class="btn-group" role="group" aria-label="Period">
                                <a href="{{ secure_redirect(route('multi-bars.show', ['multiBar' => $multiBar->id, 'report' => true, 'period' => 'day'])) }}"
                                   class="btn btn-info btn-sm {{ $searchParams['period'] == 'day' ? 'active' : '' }}">
                                    Today
                                </a>
                                <a href="{{ secure_redirect(route('multi-bars.show', ['multiBar' => $multiBar->id, 'report' => true, 'period' => 'week'])) }}"
                                   class="btn btn-info btn-sm {{ $searchParams['period'] == 'week' ? 'active' : '' }}">
                                    Last 7days
                                </a>
                                <a href="{{ secure_redirect(route('multi-bars.show', ['multiBar' => $multiBar->id, 'report' => true, 'period' => 'month'])) }}"
